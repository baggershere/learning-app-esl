  ...
  try {
    ...
    const { data } = await axios.post(
      process.env.NODE_ENV == "production"
        ? "https://esl-complete-app.herokuapp.com/api/fetchprofileinfo"
...
export const addChild = (name) => async (dispatch) => {
  try {
    ...
    await axios.post(
      process.env.NODE_ENV === "production"
        ? "https://esl-complete-app.herokuapp.com/api/addchild"
...
export const removeChild = (name) => async (dispatch) => {
  ...
  await axios.post(
    "https://esl-complete-app.herokuapp.com/api/removechild",
    { childName: name },
    { withCredentials: true }
  );
};
...
export const addScores = (score, game) => async (dispatch, getState) => {
  ...
  await axios.post(
    "https://esl-complete-app.herokuapp.com/api/submitgamescore",
    {
